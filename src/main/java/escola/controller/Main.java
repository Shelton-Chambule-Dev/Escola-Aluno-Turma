...
public class Main {
    static void main() {
        ...
        EntityManager em = JpaConnection.getEntityManagerFactory().createEntityManager();
     //   TurmaServices2 turmaServices = new TurmaServices2(em);

        DisciplinasModel disciplinasModel = new DisciplinasModel(null,"Logica de Programacao");
       DisciplinaServices disciplinaServices = new DisciplinaServices(em);
       disciplinaServices.save(disciplinasModel);
